...
pygame.display.set_caption("Juego para ti mi amor TE AMO ")

# Cargar imágenes y escalarlas
player_image = pygame.image.load("imgs/bb.jpeg")
player_image = pygame.transform.scale(player_image, (60, 60))

bullet_image = pygame.image.load("imgs/corazón.png")
bullet_image = pygame.transform.scale(bullet_image, (50, 50))   

enemy_image = pygame.image.load("imgs/yo.jpeg")
enemy_image = pygame.transform.scale(enemy_image, (60, 60))

background_image = pygame.image.load("imgs/wpa.jpeg")
